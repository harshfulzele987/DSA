...
int main()
{
	...
	printf(" 1.Find Substring in a given string.\n 2.Find index of substring in given String.\n 3.Concatenate the string.\n 4.Length of a given String.\n 5.Insert string in a given string.\n");
	printf(" 6.Delete Substring from a given String.\n 7.Delete Every occurance of Substring in a given String.\n 8.Replace substring with another substring in a given string.\n");
	printf(" 9.Get Stop Words from given string.\n 10.Get Unwanted Words from given string\n");
	printf("Operation Number: ");
	scanf("%d",&ch);       //GETTING CHOICE FROM USER
